...
The sample loading order on the RT plate are stored at this [spreadsheet](https://github.com/mmyoung/scaleBio-RNAseq-on-social_isolation-ratBrain/data/'9_6_24 12 OFC for ScaleRNA yield summary.xlsx').
